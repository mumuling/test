...
public class MultipleStatusView extends LinearLayout {
    ...
    public MultipleStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEmptyViewResId =
                a.getResourceId(R.styleable.MultipleStatusView_emptyView, R.layout.placeholder_empty_view);
        mErrorViewResId =
                a.getResourceId(R.styleable.MultipleStatusView_errorView, R.layout.placeholder_error_view);
        mLoadingViewResId = a.getResourceId(R.styleable.MultipleStatusView_loadingView, R.layout.placeholder_loading_view);
    ...
    public final void showError() {
        ...
        if (null == mErrorView) {
            ...
            if (null != mOnRetryClickListener && mErrorRetryView != null) {
