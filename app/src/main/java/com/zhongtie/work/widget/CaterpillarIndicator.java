...
public class CaterpillarIndicator extends LinearLayout implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public CaterpillarIndicator(Context context, AttributeSet attrs) {
        ...
        isSelectTextBold = a.getBoolean(R.styleable.CaterpillarIndicator_slide_text_bold, false);
    ...
    /**
     * initTitle indication
     *
     * @param startPos   initTitle select pos
     * @param tabs       title list
     * @param mViewPager ViewPage
     */
    public void initTitle(int startPos, List<TitleInfo> tabs, ViewPager mViewPager) {
        removeAllViews();
    ...
    private void setTabTextSize(View tab, boolean selected) {
        if (tab instanceof TextView) {
            ...
            if (isSelectTextBold) {
                tv.setTypeface(selected ? Typeface.defaultFromStyle(Typeface.BOLD) : Typeface.DEFAULT);
            }
        }
    }
