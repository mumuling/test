package com.zhongtie.work.ui.safesupervision.dialog.wheel;
...
public class WheelView extends View {
     ...
     * Items text color
     */
    private static final int ITEMS_TEXT_COLOR = 0x7f999999;
    ...
    protected void notifyChangingListeners(int oldValue, int newValue) {
        // Yuyue.mHandler.sendEmptyMessage(1001);
        // Yuyue.mHandler.sendEmptyMessage(1002);
