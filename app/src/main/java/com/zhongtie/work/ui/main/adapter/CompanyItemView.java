...
@BindItemData(CompanyEntity.class)
public class CompanyItemView extends AbstractItemView<CompanyEntity, CommonViewHolder> {
    @Override
    ...
    @Override
    public void onBindViewHolder(@NonNull CommonViewHolder vh, @NonNull CompanyEntity data) {
